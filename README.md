...
| **Acebook** | A social media clone that allows signed up users to write posts and view a news feed of existing posts with an ability to like and unlike as they wish. | Used effective techniques to learn React.js in a short time-frame. This allowed me to refractor our Rails code to give the user's homescreen complete single-page functionality. |Ruby-on-Rails, React.js, Rspec |
