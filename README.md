...
| **Looking Glass**            | Web app that allows users to create watchlists and film recommendations based on what their friends have picked for them.| 
-	Responsible for creating the components that fetch and display data from the API. 
